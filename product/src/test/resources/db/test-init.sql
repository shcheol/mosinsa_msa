...
insert into stock values ('stockId1',10,10,'ON');
insert into stock values ('stockId2',20,20,'ON');
insert into stock values ('stockId3',30,30,'ON');
insert into stock values ('stockId4',30,30,'ON');
insert into stock values ('stockId5',30,30,'ON');
