...
public class CouponEventCreateRequest {
    ...
    public CouponEventCreateRequest(String displayName, DiscountPolicy discountPolicy, int quantity, LocalDateTime eventStartAt, LocalDateTime expiryDate) {
        Assert.notNull(displayName,"이벤트 이름은 필수입니다.");
