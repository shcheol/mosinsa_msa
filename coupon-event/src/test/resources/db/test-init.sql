...
values ('promotion1', '최대 10000원 쿠폰 증정', '신규 가입고객 10000원, 기존 고객 3000원 쿠폰', 'ONCE', '2023-10-28', '2025-10-29', 1),
       ('promotion2', '컴백 이벤트', '신규 고객은 10%, 10000원 쿠폰, 3개월 주문이력이 없는 고객에게 10% 쿠폰', 'ONCE', '2023-10-31', '2024-11-30', 2),
...
values (1, 'promotion1', 1, '2023-10-31', '2024-11-30'),
       ...
       (4, 'promotion2', 3, '2023-10-31', '2024-11-30'),
       (5, 'promotion2', 4, '2023-10-31', '2024-11-30'),
       (6, 'promotion2', 5, '2023-10-31', '2024-11-30'),
       (7, 'promotion3', 6, '2023-10-31', '2024-11-30');

insert into coupon_group_info(id, coupon_group_sequence, discount_policy, quantity, quest_id, created_date,
                              last_modified_date)
values (1, 4, 'WON_10000', 300, 1, '2023-10-31', '2024-11-30'),
       (2, 3, 'WON_3000', 300, 2, '2023-10-31', '2024-11-30'),
       (3, 1, 'PERCENT_10', 300, 3, '2023-10-31', '2024-11-30'),
       (4, 4, 'WON_10000', 300, 4, '2023-10-31', '2024-11-30'),
       (5, 1, 'PERCENT_10', 300, 5, '2023-10-31', '2024-11-30'),
       (6, 2, 'WON_1000', 300, 7, '2023-10-31', '2024-11-30'),
       (7, 3, 'WON_3000', 300, 7, '2023-10-31', '2024-11-30'),
       (8, 4, 'WON_10000', 300, 7, '2023-10-31', '2024-11-30');
...
values ('coupon1', 'memberId1', '2023-12-31', 'PERCENT_10', '2025-12-31', 3000, 'ISSUED');
insert into coupon(coupon_id, member_id, issued_date, discount_policy, during_date, min_use_price, state)
values ('coupon2', 'memberId2', '2023-12-31', 'PERCENT_10', '2025-12-31', 3000, 'ISSUED');
insert into coupon(coupon_id, member_id, issued_date, discount_policy, during_date, min_use_price, state)
values ('coupon3', 'memberId2', '2023-12-31', 'PERCENT_10', '2025-12-31', 3000, 'ISSUED');
insert into coupon(coupon_id, member_id, issued_date, discount_policy, during_date, min_use_price, state)
values ('coupon4', 'memberId2', '2023-12-31', 'PERCENT_10', '2025-12-31', 3000, 'ISSUED');