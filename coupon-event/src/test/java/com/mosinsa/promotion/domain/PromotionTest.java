...
class PromotionTest {
	...
	void equalsAndHashCode(){
		...
		Promotion promotion = Promotion.create("title", "context", 10, DiscountPolicy.NONE,
				new PromotionPeriod(now, now.plusDays(2)), CouponDetails.of(now.plusMonths(3), DiscountPolicy.NONE));
